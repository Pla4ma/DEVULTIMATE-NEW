        ...
        <div className="grid grid-cols-2 gap-1.5">
          {COMPILE_MODES.map((m) => (
            <button
              ...
              style={{
                background:
                  compileMode === m.key ? `${TOOL.accent}15` : "var(--surface-2)",
                border: `1px solid ${compileMode === m.key ? TOOL.accent : "var(--border-default)"}`,
              }}
            >
              <span
                ...
                style={{
                  color:
                    compileMode === m.key ? TOOL.accent : "var(--text-primary)",
                }}
              >
                {m.label}
              </span>
